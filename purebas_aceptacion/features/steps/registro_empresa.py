...
def step_impl(context):
    context.driver.find_element_by_xpath(
        '/html/body/div[2]/header/div[2]/div[2]/div/div/div[2]/ul/li/a[2]').click()
    time.sleep(1)
...
def step_impl(context):
    context.driver.find_element_by_xpath(
        '/html/body/div[3]/div/div/p/a').click()
    time.sleep(1)
...
def step_impl(context, contra2):
    context.driver.find_element_by_xpath(
        '/html/body/div[3]/div/div/div/form/div[4]/div/input').send_keys(contra2)
    time.sleep(1)
...
def step_impl(context):
    button = context.driver.find_element_by_xpath(
        "/html/body/div[3]/div/div/div/form/div[10]/button")
