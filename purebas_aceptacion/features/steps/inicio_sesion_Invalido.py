...
def step_impl(context):
    context.driver.find_element_by_xpath(
        '/html/body/div[2]/header/div[2]/div[2]/div/div/div[2]/ul/li/a[1]').click()
    time.sleep(4)
...
def step_impl(context):
    context.driver.find_element_by_xpath(
        '/html/body/div[3]/section/div/div/div[1]/div/form/div[3]/button').click()
    time.sleep(2)
...
def step_impl(context):
    assert context.driver.find_element_by_xpath(
        '/html/body/div[3]/p').text == "Usuario no encontrado"
